...
Como tecnologia front-end, utilizaremos React e Redux.
...
Utilizamos também a base de dados de qualidade da Internet no Brasil do SIMET
(Sistema de Medição de Trafego Internet) \cite{simet}. O SIMET é um projeto do
NIC.br (Núcleo de Informação e Coordenação do Ponto BR), cujo objetivo é medir a
qualidade da Internet de maneira independente.
...
implementações quanto de requisitos necessários. Criamos o cronograma do
trabalho, apresentado no diagrama de Gantt da Figura \ref{fig:gantt}

\begin{figure}[H]
    \centering
    \includegraphics[width=6in]{imagens/gantt.png}
    \caption{Diagrama de Gantt.}
    \label{fig:gantt}
  \end{figure}

Levantados os requisitos no
...
\begin{thebibliography}{9}
    ...
    \bibitem{simet}
    NIC.br.
    \textit{Simet - O melhor medidor de Internet}.
    Disponível em:
    http://simet.nic.br/mapas-app.html
