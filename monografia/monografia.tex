...
% TODO Eric: Deployment do front-end
...
\ref{table:test-taguchi}, do Método Taguchi. A definição de cada função e
seu domínio de busca está disponível na referência~\cite{optimization-functions}.
...
% TODO Nakajo: Medidas de desempenho

\section{User Experience}

% TODO Nakajo: Ver se um usuário leigo conseguiria usar o sistema, e documentar a
% interação

\section{Resultados}

% TODO Eric: Comentários sobre código final
...
% TODO Eric: Recapitulação e visão geral sobre o projeto, falar impressões

\section{Conclusões do Projeto de Formatura}

% TODO Eric: Falar mais especificamente sobre o que deu certo e errado
