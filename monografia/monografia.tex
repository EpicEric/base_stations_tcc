...
\subsection{Função a ser otimizada}
...
de figuras geométricas, de modo que as áreas de intercecção não são somadas 
múltiplas vezes. Esse cálculo é feito apenas uma vez no início do 
algoritmo. Em cada iteração do método numérico, calculamos apenas a área
das novas ERBs e somamos com a variável acumuladora. Esse é o valor a ser
otimizado pelos métodos numéricos.
...
\section{Testes do cálculo da posição ideal para instalação}
