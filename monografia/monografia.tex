...
$20.99km^2$. Os resultados estão nas figuras \ref{fig:basinhopping_exemplo} e \ref{fig:slsqp_exemplo},
respectivamente.
...
O resultado do método Taguchi para duas novas antenas está na figura \ref{fig:taguchi-sem-infra}.
...
método Taguchi só suporta duas novas antenas, usamos o método \textit{Basinhopping}.
