...
Para elaborar o \textit{front-end}, usamos a biblioteca Vue.js.
...
Usamos o axios.js % TODO Nakajo: Explicar o que é
...
ao cabeçalho \texttt{Authorization} do
HTTP. Caso o usuário tentasse acessar a página de mapas e o \textit{token} não
