...
corretamente com os métodos numéricos. Selecionamos uma área retangular nas 
proximidades da Cidade Universitária da USP. A área de cobertura atual na região 
é de $19.85km^2$. Rodamos o algoritmo com o método Taguchi para cálculo das
posições de duas novas antenas. A nova área de cobertura foi $21.21km^2$.
O resultado está na Figura \ref{fig:taguchi_exemplo}.

\begin{figure}[H]
    \centering
    \includegraphics[width=4in]{imagens/taguchi-2-erb}
    \caption{Cálculo da nova posição de otimização pelo método Taguchi.}
    \label{fig:taguchi_exemplo}
\end{figure}

Repetimos o processo para os métodos Basinhopping e SLSQP. O método primeiro
conseguiu uma nova área de cobertura de $21.27km^2$, e o segundo conseguiu
$20.99km^2$. Os resultados estão nas Figuras \ref{fig:basinhopping_exemplo} e
\ref{fig:slsqp_exemplo},
respectivamente.

\begin{figure}[H]
    \centering
    \includegraphics[width=4in]{imagens/basinhopping-2-erb}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=4in]{imagens/slsqp-2-erb}
...
Testamos também o caso de infraestrutura ausente, ou seja, quando não há antenas
instaladas na região.

O resultado do método Taguchi para duas novas antenas está na Figura
\ref{fig:taguchi-sem-infra}.

\begin{figure}[H]
    \centering
    \includegraphics[width=4in]{imagens/taguchi-2-erb-sem-infra}
    \caption{Método Taguchi com infraestrutura ausente.}
    \label{fig:taguchi-sem-infra}
\end{figure}

Repetimos o experimento para oito novas antenas. Como nossa implementação do 
método Taguchi só suporta duas novas antenas, usamos o método Basinhopping.
O resultado está na Figura \ref{fig:basinhopping-sem-infra}.

\begin{figure}[H]
    \centering
    \includegraphics[width=4in]{imagens/basinhopping-8-erb-sem-infra}
    \caption{Basinhopping com infraestrutura ausente.}
    \label{fig:basinhopping-sem-infra}
\end{figure}

Como pode ser visto pelas figuras, nesses casos os algoritmos distribuem as 
antenas evitando sobreposição entre elas.
