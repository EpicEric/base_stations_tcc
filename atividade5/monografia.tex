...
dados muito alto tanto em processamento quanto em rede torna uma utilização com muitos clientes inviável.
...
referência a biblioteca  ``django-geohash-cluster'' \cite{geohashcluster}.
